            ...
            <>
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <div className="bg-sage-50 p-4 rounded-lg space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>info@tierischgutbetreut.de</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    Wenn Sie diese Website besuchen, erfasst Vercel Logfiles inklusive Ihrer IP-Adressen. 
                  ...
                  <p>
                    ...
                    Einwilligung is jederzeit widerrufbar.
                  </p>
                </div>
              </div>
