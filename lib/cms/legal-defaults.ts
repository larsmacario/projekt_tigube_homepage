export const impressumHtml = `<h2>Unternehmensinformationen</h2>
<h3>Firmenname</h3>
...
<h3>Copyright</h3>
<p>© tierisch gut betreut 2025</p>`

export const datenschutzHtml = `<h2>1. Datenschutz auf einen Blick</h2>
...
export const agbHtml = `<p><strong>tierisch gut betreut Gesellschaft mit beschränkter Haftung</strong></p>
...
export const LEGAL_DEFAULTS = {
  ...
  datenschutz: { title: 'Datenschutzerklärung', content: datenschutzHtml },
  agb: { title: 'Pflegevertrag', content: agbHtml },
} as const
...
export function getLegalContent(
  ...
  const defaults = LEGAL_DEFAULTS[key]
  return {
