...
const LEAD_STANDARD_COLUMNS: TableColumn[] = [
  ...
  },
  {
    ...
    fieldType: 'text',
    fieldName: 'notfall_kontakt_name',
    sortable: true,
    filterable: true,
    width: 180,
  },
...
export function getCustomerColumnCatalog(
  ...
  const standardColumns: TableColumn[] = [
    ...
    },
    {
      ...
      label: 'Intervall Impfung',
      fieldType: 'select',
      fieldName: 'intervall_impfung',
      sortable: true,
      filterable: true,
      width: 160,
    ...
    },
    {
      ...
      label: 'Intervall Entwurmung',
      fieldType: 'select',
      fieldName: 'intervall_entwurmung',
      sortable: true,
      filterable: true,
      width: 170,
      options: ['monatlich', 'vierteljährlich', 'halbjährlich', 'jährlich', 'alle_2_jahre', 'alle_3_jahre'],
    ...
    {
      id: 'onboarding_email_error',
      label: 'Onboarding-Mail Fehler',
      fieldType: 'textarea',
      fieldName: 'onboarding_email_error',
      sortable: false,
      filterable: false,
      width: 200,
      readOnly: true,
